...
const NAV = [
  ...
  { href: "/student/learning-path", label: "AI 학습 경로", exact: false },
    ...
    <aside className="w-56 shrink-0 bg-white dark:bg-[#0d1224] border-r border-gray-200 dark:border-gray-700/50 flex flex-col h-full">
      ...
      <div className="px-4 py-4 border-t border-gray-200 dark:border-gray-700/50">
        <div className="flex items-center gap-2.5 mb-3">
          <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-xs font-medium text-blue-700 dark:text-blue-300 shrink-0">
            {initial}
          </div>
          <div className="min-w-0">
            <p className="text-sm text-gray-900 dark:text-white truncate">{userName}</p>
            <p className="text-xs text-gray-400 dark:text-gray-500">수강생</p>
          </div>
        </div>
