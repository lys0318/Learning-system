...
const NAV_SECTIONS = [
  {
    label: "메인",
    items: [
      { href: "/student", label: "대시보드", icon: "🏠", exact: true },
      { href: "/student/my-courses", label: "내 강의", icon: "📚", exact: false },
      { href: "/student/calendar", label: "학습 캘린더", icon: "📅", exact: false },
    ],
  },
  {
    label: "AI 기능",
    items: [
      { href: "/student/ai-tutor", label: "AI 튜터", icon: "🤖", exact: false },
      { href: "/student/learning-path", label: "AI 학습 경로", icon: "🗺️", exact: false },
    ],
  },
  {
    label: "커뮤니티",
    items: [
      { href: "/student/messages", label: "선생님 질문", icon: "💬", exact: false },
    ],
  },
  {
    label: "학습",
    items: [
      { href: "/student/courses", label: "강의 둘러보기", icon: "🔍", exact: true },
      { href: "/student/quizzes", label: "퀴즈", icon: "🎯", exact: false },
    ],
  },
];
          ...
          <div key={section.label} className="mb-4">
            ...
            {section.items.map(({ href, label, icon, exact }) => {
              ...
              return (
                ...
                >
                  {active && (
                    <span className="absolute left-0 top-[20%] bottom-[20%] w-[3px] rounded bg-blue-500" />
                  )}
      ...
      <div className="px-3 py-3 border-t border-gray-200 dark:border-white/[0.06]">
        <div className="flex items-center gap-2.5 p-2.5 rounded-xl dark:bg-white/[0.04] bg-gray-100 mb-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-gray-400 dark:text-gray-600">수강생</p>
          </div>
        </div>
